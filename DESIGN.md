...
- **POI 搜索**：腾讯地图 Place API（地图首页补充营地）
...
- **需开通的服务**:
  - WebService API - 地点搜索 (Place API): 用于地图首页的 POI 搜索
...
| 线路规划 | `pages/route/` | TabBar | 起终点选择(wx.chooseLocation)、途经点排序、驾车路线、沿途营地(5km走廊) |
...
| POI 搜索混入非营地结果 | 关键词"露营"太宽泛，匹配到"北京自驾蔚县露营徒步之旅"等旅行路线 | 收紧匹配条件：仅匹配"露营地""房车营地"等具体营地词，新增排除词（旅行/之旅/徒步/自驾/攻略/俱乐部/装备等） | 08-16 |
...
| 改进 | 说明 |
|------|------|
| POI 搜索关键词收紧 | 从"露营"改为"露营地""房车营地"等具体词，避免匹配旅行路线 |
| POI 排除词扩充 | 新增旅行/之旅/徒步/自驾/攻略/俱乐部/用品/装备/销售/农庄/度假/民宿等 18 个排除词 |
